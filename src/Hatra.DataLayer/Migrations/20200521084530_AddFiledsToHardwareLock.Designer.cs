...
namespace Hatra.DataLayer.Migrations
{
    ...
    [Migration("20200521084530_AddFiledsToHardwareLock")]
    partial class AddFiledsToHardwareLock
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hatra.Entities.HardwareLock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("AndroidUserCount");
                    ...
                    b.ToTable("HardwareLocks");
                });

            modelBuilder.Entity("Hatra.Entities.HardwareLockFinancialYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("HardwareLockId");

                    b.ToTable("HardwareLockFinancialYears");
                });
            ...
            modelBuilder.Entity("Hatra.Entities.HardwareLockFinancialYear", b =>
                {
                    b.HasOne("Hatra.Entities.HardwareLock", "HardwareLock")
                        .WithMany("FinancialYears")
                        .HasForeignKey("HardwareLockId")
